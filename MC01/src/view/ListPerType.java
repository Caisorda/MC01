                        ...
                        if (event.getStateChange() == ItemEvent.SELECTED) {
                            switch((String)cbProduce.getSelectedItem()){
                                ...
                                case "Livestock": switch(item.toString()){
                                                        case "All": result = mc.optimizedProduceLivestock();result.remove(0);
                                                                    typesTA.setText("");
                                                                    typesTA.setEditable(false);
                                                                 break;
                                                        case "Hog": result = mc.optimizedProduceLivestock(Livestock.HOG_KEY);result.remove(0);
                                                                          typesTA.setText("");
                                                                          typesTA.setEditable(false);
                                                                 break;
                                                        case "Goat": result = mc.optimizedProduceLivestock(Livestock.GOAT_KEY);result.remove(0);
                                                                      typesTA.setText("");
                                                                      typesTA.setEditable(false);
                                                                 break;
                                                        case "Carabao": result = mc.optimizedProduceLivestock(Livestock.CARABAO_KEY);result.remove(0);
                                                                     typesTA.setText("");
                                                                     typesTA.setEditable(false);
                                                                 break;
                                                        case "Cow": result = mc.optimizedProduceLivestock(Livestock.COW_KEY);result.remove(0);
                                                                       typesTA.setText("");
                                                                       typesTA.setEditable(false);
                                                                 break;
                                                        case "Chicken": result = mc.optimizedProduceLivestock(Livestock.CHICKEN_KEY);result.remove(0);
                                                                       typesTA.setText("");
                                                                       typesTA.setEditable(false);
                                                                 break;
                                                        case "Duck": result = mc.optimizedProduceLivestock(Livestock.DUCK_KEY);result.remove(0);
                                                                       typesTA.setText("");
                                                                       typesTA.setEditable(false);
                                                                 break;
                                                        case "Others": typesTA.setEditable(true);
                                ...
                                case "Aquatic/Fishery": switch(item.toString()){
                                                        case "All": result = mc.optimizedProduceFish();result.remove(0);
                                                                    typesTA.setText("");
                                                                    typesTA.setEditable(false);
                                                                 break;
                                                        case "Tilapa": result = mc.optimizedProduceFish(Fish.TILAPIA_KEY);result.remove(0);
                                                                          typesTA.setText("");
                                                                          typesTA.setEditable(false);
                                                                 break;
                                                        case "Milkfish": result = mc.optimizedProduceFish(Fish.MILKFISH_KEY);result.remove(0);
                                                                      typesTA.setText("");
                                                                      typesTA.setEditable(false);
                                                                 break;
                                                        case "Catfish": result = mc.optimizedProduceFish(Fish.CATFISH_KEY);result.remove(0);
                                                                     typesTA.setText("");
                                                                     typesTA.setEditable(false);
                                                                 break;
                                                        case "Mudfish": result = mc.optimizedProduceFish(Fish.MUDFISH_KEY);result.remove(0);
                                                                       typesTA.setText("");
                                                                       typesTA.setEditable(false);
                                                                 break;
                                                        case "Carp": result = mc.optimizedProduceFish(Fish.CARP_KEY);result.remove(0);
                                                                       typesTA.setText("");
                                                                       typesTA.setEditable(false);
                                                                 break;
                                                        case "Others": typesTA.setEditable(true);
		...
		typesTA = new JTextField();
                ...
                typesTA.addActionListener(new ActionListener(){
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        ArrayList<Municipality> result = new ArrayList<>();
                        switch((String)cbProduce.getSelectedItem()){
                            case "Agricultural": result = mc.optimizedProduceCrops(textField.getText());result.remove(0);
                                                 break;
                            case "Livestock": result = mc.optimizedProduceLivestock(textField.getText());result.remove(0);
                                              break;
                            case "Aquatic/Fishery": result = mc.optimizedProduceFish(textField.getText());result.remove(0);
                                                    break;
                        }
                        String[] towns = new String[result.size()];
                        for(int i = 0; i < result.size() ; i++){
